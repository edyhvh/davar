	...
	return (
		<div className="space-y-8 p-6 max-w-4xl mx-auto">
			...
			<GlassCard className="p-8">
				...
				>
					<p className="text-lg">
						<strong className="text-[var(--primary)]">מינימליזם קדוש</strong>{" "}
						(Minimalism Kadosh)
					</p>
					<p className="text-[var(--text-secondary)]">
						Beauty in functional simplicity. No distractions. Reverent design
						that invites deep meditation on Hebrew Scripture. Every element
						serves a purpose, every space has meaning.
					</p>
				...
				<div className="space-y-6">
					<div>
						...
						<p className="text-sm text-[var(--text-secondary)] mt-3">
							The logo features a stylized Phoenician Dalet (ד) letter with a
							blue-to-teal gradient, symbolizing the opening door to ancient
							wisdom. Paired with Hebrew text "דבר" (Davar), meaning "word" or
							"thing."
						</p>
					</div>
						...
						<div className="grid grid-cols-2 gap-4">
							<div>
								...
								<div className="text-xs space-y-1">
									<div>
										<code>#40C4FF</code> → <code>#006666</code>
									</div>
							...
							<div>
								...
								<div className="text-xs space-y-1">
									<div>
										<code>#006666</code> → <code>#40C4FF</code>
									</div>
									<div className="text-[var(--text-secondary)]">
				...
				<div className="space-y-6">
					<div>
						...
						<ul className="space-y-2 text-sm text-[var(--text-secondary)]">
							...
							<li>
								✓ Maintain consistent border opacity: 0.08 (light) / 0.1 (dark)
							</li>
						...
						<div className="bg-[var(--muted)] p-6 rounded-lg">
							<div className="space-y-4 text-sm">
								<div className="flex items-start gap-3">
									...
									<div>
										<strong>Verse Reference</strong>: 14px Inter, secondary
										color, centered
									</div>
								</div>
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Hebrew Text</strong>: 24px Cardo, RTL, primary
										color, 1.85 line-height
									</div>
								</div>
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Translation</strong>: 16px Inter, secondary color,
										centered
									</div>
								</div>
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Qumran Variant</strong> (optional): 22px
										DeadSeaScrolls, RTL, 80% opacity
									</div>
								</div>
							</div>
						</div>
						...
						<div className="bg-[var(--muted)] p-6 rounded-lg">
							<div className="space-y-4 text-sm">
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Word Display</strong>: 48px Cardo, RTL, centered,
										primary color
									</div>
								</div>
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Meanings List</strong>: 16px Inter, bulleted,
										secondary color
									</div>
								</div>
								<div className="flex items-start gap-3">
								...
								<div className="flex items-start gap-3">
									<div className="w-2 h-2 bg-[var(--primary)] rounded-full mt-2" />
									<div>
										<strong>Instance Cards</strong>: 3-column grid, glass cards,
										tappable
									</div>
								</div>
							</div>
				...
				<div className="space-y-4 text-sm">
					<div>
						...
						<p className="text-[var(--text-secondary)] mt-2">
							Max-width: 448px (28rem). All components optimized for portrait
							iPhone/Android. This is the primary and recommended viewport for
							the application.
						</p>
					</div>
					<div>
						...
						<p className="text-[var(--text-secondary)] mt-2">
							Content remains centered in a mobile-width container with shadow
							for card-like appearance. Background extends to fill viewport.
						</p>
					</div>
					<div>
						<strong className="text-base">Font Scaling</strong>
						<p className="text-[var(--text-secondary)] mt-2">
							Users can choose small/medium/large font sizes. All components
							adapt proportionally. Default base font size: 16px.
						</p>
					</div>
				</div>
			</GlassCard>
			...
			<GlassCard className="p-8">
				...
				<div className="space-y-4 text-sm">
					<div>
						...
						<p className="text-[var(--text-secondary)] mt-2">
							Built with React, Tailwind CSS v4, and TypeScript. Uses CSS custom
							properties for theming. All fonts loaded via Google Fonts CDN.
						</p>
					</div>
					<div>
						<strong className="text-base">Browser Support</strong>
						<p className="text-[var(--text-secondary)] mt-2">
							Modern browsers with backdrop-filter support (Chrome 76+, Safari
							14+, Firefox 103+). Graceful degradation for older browsers with
							solid backgrounds.
						</p>
					</div>
					<div>
						...
						<p className="text-[var(--text-secondary)] mt-2">
							Optimized for mobile devices. Lazy loading for heavy components.
