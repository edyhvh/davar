		...
		<div className="space-y-8 p-6">
			...
			<GlassCard className="p-6 space-y-4">
				...
				<div className="space-y-3">
					...
					/>
					<select className="w-full px-4 py-2 bg-[var(--input-background)] backdrop-blur-sm border border-[var(--glass-border)] rounded-lg outline-none focus:ring-2 focus:ring-[var(--primary)] transition-all">
			...
			<GlassCard className="p-6 space-y-4">
				...
				<div className="space-y-3">
					...
					<p style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px" }}>
						Body text - Inter 16px. This is the standard body text used
						throughout the application for readable content.
					</p>
					<p
						className="text-sm text-[var(--text-secondary)]"
						style={{ fontFamily: "'Inter', sans-serif" }}
					>
						Small text - Inter 14px. Used for secondary information and
						metadata.
					</p>
					<p
