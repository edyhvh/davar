			...
			colors: [
				{
					...
					value: "#0038B8",
					var: "--accent (light)",
					desc: "Primary tekhelet - Light theme",
				},
				{
					name: "Mid",
					value: "#002B80",
					var: "--accent-to",
					desc: "Gradient middle",
				},
				{
					name: "Deep",
					value: "#001F59",
				...
				},
				{
					...
					value: "#0044CC",
					var: "--accent (dark)",
					desc: "Brighter variant - Dark theme",
				},
			],
		},
		{
			...
			colors: [
				...
				{
					name: "Copper Glow",
					value: "rgba(205, 127, 50, 0.1)",
					var: "--copper-glow",
					desc: "Subtle glow",
				},
				{
					name: "Copper Background",
					value: "rgba(184, 115, 51, 0.05)",
					var: "--copper-background-subtle",
					desc: "Hint background",
				},
			],
		},
		{
			...
			colors: [
				{
					name: "Base 10%",
					value: "rgba(0, 56, 184, 0.1)",
					var: "--accent-glow",
					desc: "Subtle glow",
				},
				{
					name: "Dark 15%",
					value: "rgba(0, 43, 128, 0.15)",
					var: "--accent-glow-dark",
					desc: "Deeper glow",
				},
			],
		},
			...
			colors: [
				{
					...
					value: "#32302f",
					var: "--background (dark)",
					desc: "Main background - Warm charcoal",
				},
				{
					name: "Dark Text",
					value: "#ffffff",
				...
				},
				{
					name: "Dark Hebrew",
					value: "#ebdbb2",
					var: "--text-hebrew (dark)",
					desc: "Hebrew text - Warm cream",
				},
			],
		},
	];
	...
	return (
		<div className="space-y-8 p-6">
			...
			<div
				...
				style={{
					background:
						"linear-gradient(135deg, #0038B8 0%, #002B80 50%, #001F59 100%)",
				}}
			>
			...
			<div className="bg-[var(--glass-surface)] backdrop-blur-xl border border-[var(--glass-border)] rounded-xl p-6 space-y-4">
				<h3 className="text-lg" style={{ fontFamily: "'Inter', sans-serif" }}>
					Usage Guidelines
				</h3>
				<ul
				...
				>
					<li>
						• Use Primary Base (#0038B8) for buttons, links, and primary actions
					</li>
					<li>
						• Apply the tekhelet gradient for logo, launch screen, and hero
						elements
					</li>
					<li>
						• Use RGBA variants for glassmorphism effects and subtle glows
					</li>
