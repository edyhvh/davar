...
import { Globe, Book, Search, Settings, Sun, Moon, Heart, Smartphone } from 'lucide-react';
...
export function DesignSystemExport({ theme, onThemeChange, onClose, initialView = 'web' }: DesignSystemExportProps) {
  const [currentView, setCurrentView] = React.useState<'web' | 'mobile'>(initialView);
