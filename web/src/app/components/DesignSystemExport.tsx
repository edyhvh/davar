	...
	const colorTokens = {
			...
			accent: [
				{
					name: "Accent Base",
					value: "#7AA0D6",
					desc: "Primary interactive elements",
				},
				{ name: "Accent From", value: "#7AA0D6", desc: "Gradient start" },
				{
					name: "Accent To",
					value: "#6389BF",
					desc: "Gradient end, hover base",
				},
				...
				{ name: "Accent Deep", value: "#4C72A8", desc: "Pressed/deep states" },
				{
					name: "Accent Light",
					value: "#A8C8F0",
					desc: "Soft fills, selected states",
				},
				{
					name: "Accent Darker",
					value: "#3D5A8C",
					desc: "Darker blue for donate button",
				},
			],
			copper: [
				{ name: "Copper Base", value: "#B07A3C", desc: "Main copper" },
				{
					...
					value: "#C68F55",
					desc: "Qumran variants highlighting",
				},
			],
			neutral: [
				{
					name: "Background",
					value: "#FDFDF9",
					desc: "Warm ivory page background",
				},
			...
			neomorph: [
				{
					name: "Neomorph BG",
					value: "#FDFDF9",
					desc: "Button/card background",
				},
				{
					name: "Shadow Dark",
					value: "rgba(190, 190, 200, 0.4)",
					desc: "Dark shadow",
				},
				{
					name: "Shadow Light",
		...
		dark: {
			...
			neomorph: [
				...
				{
					name: "Shadow Light",
					value: "rgba(40, 40, 50, 0.3)",
					desc: "Light shadow",
				},
				{
					name: "Border",
					value: "rgba(70, 80, 110, 0.25)",
					desc: "Subtle borders",
				},
			],
		},
		...
		<div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] p-8">
			<div className="max-w-7xl mx-auto space-y-16">
				...
				<header className="text-center space-y-6 py-12">
					...
					>
						Kadosh Minimalism - Beauty in functional simplicity with reverent
						design inviting deep meditation
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<NeumorphCard className="p-6 space-y-3">
							...
							<p
								...
								style={{ fontFamily: "'Inter', sans-serif" }}
							>
								Sacred minimalism - beauty through functional simplicity with no
								distractions
							</p>
						</NeumorphCard>
						<NeumorphCard className="p-6 space-y-3">
							...
							<p
								...
								style={{ fontFamily: "'Inter', sans-serif" }}
							>
								Neumorphic design with soft shadows creating contemplative depth
						...
						<NeumorphCard className="p-6 space-y-3">
							...
							<p
								...
								style={{ fontFamily: "'Inter', sans-serif" }}
							>
								Proper RTL support, generous line height, warm text colors for
								...
								<div key={color.name} className="space-y-3">
									<div
										...
										style={{
											...
											borderColor: color.name.includes("Border")
												? color.value
												: "var(--neomorph-border)",
										}}
									/>
							...
							<NeumorphCard key={type.name} className="p-6">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									<div>
										...
										>
											<div>
												<strong>Family:</strong> {type.family}
											</div>
											<div>
												<strong>Weight:</strong> {type.weight}
											</div>
											<div>
												<strong>Size:</strong> {type.size}
											</div>
											<div>
												<strong>Line Height:</strong> {type.lineHeight}
											</div>
											<div>
								...
								<div>
									...
									>
										...
										<div>
											...
											<div className="font-mono text-xs">
												inset 3px 3px 6px var(--neomorph-inset-shadow-dark)
											</div>
											<div className="font-mono text-xs">
												inset -3px -3px 6px var(--neomorph-inset-shadow-light)
											</div>
										</div>
									</div>
								</div>
							...
							<div className="pt-6 border-t border-[var(--neomorph-border)]">
								...
								>
									<li>
										...
										for Hebrew text containers
									</li>
									<li>
										• Line height 1.8-2.0 for scripture (better readability with
										nikud)
									</li>
									<li>
										• Cardo font for main Hebrew text, Arimo for UI Hebrew
									</li>
									<li>
										• Warm cream (#ebdbb2) color in dark mode for reduced eye
										strain
									</li>
									<li>
										• Qumran variants highlighted with copper color (#C68F55 /
										#B5814A)
									</li>
								</ul>
							</div>
